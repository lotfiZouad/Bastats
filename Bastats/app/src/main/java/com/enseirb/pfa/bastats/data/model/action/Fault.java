...
public class Fault extends Action{
    public static final String PERSONAL ="P";
    public static final String TECHNICAL ="T";
    public static final String UNSPORTING="U";
    public static final String DISQUALIFYING ="D";
    ...
    public Fault(PlayingTime time, Player playerActor, Player playerTargeted) {
    ...
    public Fault(PlayingTime time, Player playerActor) {
        setPlayingTime(time.getId());
        setActorPlayer(playerActor.getId());
        setComment("");
        setTargetedPlayer(NO_ID);
